---
title: "gsd-assumptions-analyzer (external agent)"
type: agent-mirror
external: true
...
related:
  - "[[00-MOC]]"
  - "[[agents/external/gsd-discuss-phase]]"
...
# `gsd-assumptions-analyzer` (external Claude Code agent)

**Source**: `~/.claude/agents/gsd-assumptions-analyzer.md`  
