...
WHERE agent = "[[agents/archivist]]"
SORT date DESC LIMIT 10
```

_(Si no tienes plugin Dataview, mira `02-sessions/` y filtra por frontmatter `agent: "[[agents/archivist]]"`.)_
...
`agents/archivist/runs/YYYY-MM-DD/HHMMSS-from-<parent>.md`
