...
role: worker
agent_id: auditor
workspace: /home/node/.openclaw/workspace/agents/auditor
...
WHERE agent = "[[agents/auditor]]"
SORT date DESC LIMIT 10
```

_(Si no tienes plugin Dataview, mira `02-sessions/` y filtra por frontmatter `agent: "[[agents/auditor]]"`.)_
...
`agents/auditor/runs/YYYY-MM-DD/HHMMSS-from-<parent>.md`
