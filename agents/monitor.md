...
role: worker
agent_id: monitor
workspace: /home/node/.openclaw/workspace/agents/monitor
model_primary: anthropic/claude-sonnet-4-6
delegation_mode: suggest
allow_agents: []
runtime_children: []
updated: 2026-05-23T07:30:01
...
WHERE agent = "[[agents/monitor]]"
SORT date DESC LIMIT 10
```

_(Si no tienes plugin Dataview, mira `02-sessions/` y filtra por frontmatter `agent: "[[agents/monitor]]"`.)_
...
`agents/monitor/runs/YYYY-MM-DD/HHMMSS-from-<parent>.md`
