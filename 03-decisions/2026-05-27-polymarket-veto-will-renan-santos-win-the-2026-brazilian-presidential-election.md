...
type: decision
date: 2026-05-27
decision: "Veto de tesis 'Will Renan Santos win the 2026 Brazilian presidential election?' (rule M1): memoria: exact slug match (score 1.00)"
alternatives:
...
- veto `will-renan-santos-win-the-first-round-of-the-2026-brazilian-presidential-election` score=0.90 (slug prefix match; same category; same price bucket low)
