...
- veto `uae-x-qatar-sever-diplomatic-relations-in-2026` score=0.40 (same category; same price bucket low)
- veto `will-hyperliquid-dip-to-12-by-december-31-2026` score=0.40 (same category; same price bucket low)
