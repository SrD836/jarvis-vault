...
type: decision
date: 2026-05-26
decision: "Veto de tesis 'Will Crude Oil (CL) hit (HIGH) $140 by end of June?' (rule M1): memoria: exact slug match (score 1.00)"
alternatives:
...
- veto `will-crude-oil-cl-hit-high-140-by-end-of-june-828-295-574-155` score=1.00 (exact slug match)
- veto `will-crude-oil-cl-hit-high-200-by-end-of-june-677` score=0.70 (slug prefix match; same category)
