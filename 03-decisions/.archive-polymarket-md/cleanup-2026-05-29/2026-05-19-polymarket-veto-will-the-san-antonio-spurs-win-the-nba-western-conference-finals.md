...
type: decision
date: 2026-05-19
decision: "Veto de tesis 'Will the San Antonio Spurs win the NBA Western Conference Finals?' (rule M1): memoria: slug prefix match; same price bucket mid (score 0.70)"
alternatives:
...
- veto `will-the-san-antonio-spurs-win-the-2026-nba-finals` score=0.70 (slug prefix match; same price bucket mid)
